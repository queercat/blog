...
looking through a few sources we can gather _(ha)_ that there is something like [7 million average users a month](https://activeplayer.io/magic-the-gathering-arena/).
...
in the same way that you don't design a bridge to hold _'like about that much...'_ you generally want to overestimate by quite a bit.
...
<highlight id="billion"># how to handle 8 billion text files</highlight>
to what do we owe a text file? and to what does a text file owe to us? well to
start they're usually very small. like teeny tiny.
...
it _could_ be worse with custom arts for each deck file. plus building a singleton deck around cards with long names
such as the oh so fun to say asmoranomardicadaistinaculdicar! (as-more-an-uh-mar-dih-cuh-dye-stin-uh-cuhl-dih-car).

<asmor>
  ![the card
  itself](https://cards.scryfall.io/png/front/d/9/d99a9a7d-d9ca-4c11-80ab-e39d5943a315.png?1632831210)
</asmor>
