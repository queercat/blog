...
hetzner doesn't want to modify the sshd_config, the Include is probably a part of the default sshd_config, and they just add that cloud-init file to enable password access for ssh.

the reason this behavior doesn't happen when you provide your pubkeys up-front is they just don't populate that cloud-init file.
