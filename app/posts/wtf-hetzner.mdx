...
hetzner already edits the sshd_config as `the ubuntu ssh package has #PermitRootLogin prohibit-password as the default config`
(source, my friend octy <a href="https://octyl.net/">https://octyl.net/</a>) so this rules out not wanting to modify the default config.
